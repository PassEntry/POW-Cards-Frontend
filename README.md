...
1. Copy the appropriate example file for your environment:
   ...
   - For staging: `cp .env.staging.example .env.staging`
...
Note: The .env files are not committed to version control for security reasons.
